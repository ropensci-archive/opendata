...
-   [banR](https://github.com/joelgombin/banR/) is an R client for the [French national adress database](http://adresse.data.gouv.fr/), a free and collaborative address database
