...
Scott Chamberlain, Thomas Leeper, Jaime Ashander</td>
<td align="left"><strong>Contact:</strong>
scott at ropensci.org</td>
</tr>
</tbody>
</table>
...
-   [googlesheets](http://cran.rstudio.com/web/packages/googlesheets/index.html): Access private or public Google Sheets by title, key, or URL. Extract data or edit data. Create, delete, rename, copy, upload, or download spreadsheets and worksheets. [Source on GitHub](https://github.com/jennybc/googlesheets)
